...
# --------------------------------------------------------------------
#   Random Multi-start local Search (MLS) for TSP
#
...
# --------------------------------------------------------------------
def multi_start_search(tsp, work, time_limit):
    print('\n[multi-start local search algorithm]')
    ...
    while cur_time - start_time < time_limit:
        ...
        random.shuffle(cur_work.tour)
        cur_work.obj = cur_work.length(tsp)
...
def main(argv=sys.argv):
    ...
    multi_start_search(tsp, work, args.time)  # multi-start local search
    work.write(tsp)
